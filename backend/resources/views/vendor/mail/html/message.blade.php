    ...
    <x-slot:footer>
        <x-mail::footer>
            ...
            @else
                ...
                {{-- PLEASE NOTE: --}}
                {{-- Garba Groove is licensed under the GNU Affero General Public License (AGPL) version 3. --}}
                {{-- You can find the full license text at: https://github.com/HiEventsDev/hi.events/blob/main/LICENSE --}}
                {{-- In accordance with Section 7(b) of the AGPL, we ask that you retain the "Powered by Garba Groove" notice. --}}
                {{-- If you wish to remove this notice, a commercial license is available at: https://hi.events/licensing --}}

                © {{ date('Y') }} {{ config('app.name') }} | Powered by <a title="Manage events and sell tickets online with Garba Groove" href="https://hi.events?utm_source=app-email-footer">Garba Groove</a>
            @endif
        </x-mail::footer>
    </x-slot:footer>
</x-mail::layout>
